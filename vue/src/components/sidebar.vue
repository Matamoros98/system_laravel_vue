            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="#"
                        ...
                        <span class="ml-3">VitaPharm</span>
                    </a>
                </li>
                <li>
                    <a href="#"
                ...
                <li class="absolute bottom-0 w-60 pb-3">
                    <a href="#"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group bottom-0">
